...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformers/jsx/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformers/jsx/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformers/jsx/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  _.each(node.comments, function (comment) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!comment.possiblyLeading) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
&nbsp;
exports.XJSNamespacedName = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error("Namespace tags are not supported. ReactJSX is not XML.");</span>
};
&nbsp;
...
&nbsp;
exports.XJSEmptyExpression = <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >  node.value = null;</span>
<span class="cstat-no" title="statement not covered" >  node.type = "Literal";</span>
};
&nbsp;
