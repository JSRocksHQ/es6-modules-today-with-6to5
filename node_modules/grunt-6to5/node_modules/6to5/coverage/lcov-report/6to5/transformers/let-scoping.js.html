...
<span class="cline-any cline-yes">52</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1246</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (node.type === "FunctionDeclaration") {
<span class="cstat-no" title="statement not covered" >          util.ensureExpressionType(node);</span>
<span class="cstat-no" title="statement not covered" >          var declar = b.variableDeclaration("var", [</span>
            b.variableDeclarator(node.id, callNode())
          ]);
<span class="cstat-no" title="statement not covered" >          declar._blockHoist = true;</span>
