# recast, _v_. [![Build Status](https://travis-ci.org/sebmck/acorn-recast.png?branch=master)](https://travis-ci.org/sebmck/acorn-recast)
...
From GitHub:
    ...
    git clone git://github.com/sebmck/acorn-recast.git
    cd recast
    npm install .
...
In less poetic terms, Recast exposes two essential interfaces, one for parsing JavaScript code (`require("acorn-recast").parse`) and the other for reprinting modified syntax trees (`require("acorn-recast").print`).
