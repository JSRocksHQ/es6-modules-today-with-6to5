...
[![Build Status](https://travis-ci.org/sebmck/acorn-ast-types.png?branch=master)](https://travis-ci.org/sebmck/acorn-ast-types)
...
From NPM:
    ...
    npm install acorn-ast-types

From GitHub:

    cd path/to/node_modules
    git clone git://github.com/sebmck/acorn-ast-types.git
    cd acorn-ast-types
    npm install .
...
`getFieldValue`:
```js
var types = require("acorn-ast-types");
...
```js
var copy = {};
require("acorn-ast-types").eachField(node, function(name, value) {
...
based primarily upon the `require("acorn-ast-types").Type.def` function:
```js
var types = require("acorn-ast-types");
